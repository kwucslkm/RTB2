...
import FreeBoard from "./page/boardPages/FreeBoard.tsx";
...
const App: React.FC = () => {
  ...
  const deleteSession = async () => {
    ...
    if (logoutResult) alert("로그아웃 되었습니다. ");
  };
  ...
  if (mode == "home") {
    ...
    homeControl = (
      <Mypage
        onUpdateSubmit={(_id, _email, _name, _managerYn) => {
          // const id = _id;
          // const email = _email;
    ...
    homeControl = <FreeBoard onBoardListClick={() => {
    ...
    homeControl = (
      <JoinForm
        onsubmitCreate={(_email, _password, _name, _managerYn) => {
