          ...
          <div id="grid">
            <span className="left">
			  ...
			  {loginYnS && managerYnS && (
				...
				{loginYnS && (
	              <li className="dropdown">Board
				  	<ul className = "dropdown-menu"> {/*드롭다운 메뉴 부분 */}
						<li className="dropdown">
			                <a href="/notice" onClick={(e) => {
			                    e.preventDefault();
			                    onBoardListClick();
			                  }}> 공지사항</a>
					    </li>
              ...
              {loginYnS && (
                <li className="dropdown">
                  <a href="/myPage" onClick={(e) => {
                      e.preventDefault();
                      onMyPageClick();
                    }}> {managerYnS && <span style = {{color:'blue'}}>(Manager)</span>} {usernameS} 님 환영합니다. </a>
                </li>
              )}
              {loginYnS && (
                <li className="dropdown">
